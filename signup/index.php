...
//$signup= false;
$result=false;
if(isset($_POST['User']) and isset($_POST['email']) and isset($_POST['pass']) and isset($_POST['phone'])){
$user = $_POST['User'];
$email = $_POST['email'];
$pass = $_POST['pass'];
$phone = $_POST['phone'];
...
<link href="<? echo $_SERVER['CONTEXT_DOCUMENT_ROOT'] ?>/photogram/__libs/assets/dist/css/bootstrap.min.css" rel="stylesheet">
...
<main class="form-signin w-100 m-auto">
  <form action ="index.php" method = "post">
    ...
    <h1 class="h3 mb-3 fw-normal">Enter req details to Sign-Up the World of <br> JD SAGAR</h1>
    ...
    <div class="form-floating">
      <input name = "phone" type="text" class="form-control" id="floatingPassword" placeholder="Phonenumber">
      <label for="floatingPassword">Phonenumber</label>
    </div>

    <button class="btn btn-primary w-45 py-2" type="submit" >Sign Up</button>
